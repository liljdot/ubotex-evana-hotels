        ...
        <>
            <ContentSection
                ...
                <div className="flex flex-col gap-1 md:gap-2 lg:gap-3 xl:gap-4">
                    ...
                    <ContentSection.Text className={openSans.className}>At Evana Hotels, luxury is not just seen, it's felt. Every detail, from our interiors to our dining, speaks of timeless elegance and bespoke hospitality.</ContentSection.Text>
                </div>
